package com.samanecorp.secureapp.hibernate;
...
import com.samanecorp.secureapp.config.PropertiesReader;
	    ...
	    public static SessionFactory getSessionFactory() {
	        if (sessionFactory == null) {
	            try {
	                ...
	                settings.put(AvailableSettings.URL, reader.getProperty("db.url"));
